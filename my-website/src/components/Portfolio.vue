<template>
  <h1 class="flex justify-center text-4xl font-bold mt-36 mb-12">Portfolio</h1>
  <section class="grid max-sm:grid-cols-1 sm:grid-cols-3 gap-20 h-full m-20">
    <div class="flex justify-center">
      <a href="https://redux-toolkits-five.vercel.app/" class="">
        ...
        />
        <p class="text-amber-950 bg-indigo-100">Wannabakery-Redux Toolkit</p>
      </a>
    </div>
    <div class="flex justify-center">
    ...
    <div class="flex justify-center">
      <a href="https://github.com/Shen880421/attendence_system" class="">
        <img class="" src="../assets/checkinoutLogo.png" alt="Spring boot" />
